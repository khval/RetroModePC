/* :ts=4
 *  $VER: retroXorTriangle.c $Revision$ (14-Oct-2017)
 *
...
/****** retromode/main/retroXorTriangle ******************************************
*
*   NAME
*      retroXorTriangle -- Description
*
*   SYNOPSIS
*      void retroXorTriangle(struct retroScreen * screen, int x1, int y1, 
...
void draw_xor_hline_fast(struct retroScreen *screen, int x,int y,int w, unsigned char c)
{
       ...
       unsigned char color)
{
	...
	for (y= my1 ; y<= my3;y++)
	{
		...
		draw_xor_hline_fast(screen,xa,y,xb-xa,color);
		draw_xor_hline_fast(screen,xb,y,xa-xb,color);
	}
}
