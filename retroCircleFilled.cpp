/* :ts=4
 *  $VER: retroCircleFilled.c $Revision$ (16-May-2018)
 *
...
/****** retromode/main/retroCircleFilled ******************************************
*
*   NAME
*      retroCircleFilled -- Description
*
*   SYNOPSIS
*      void retroCircleFilled(struct retroScreen * screen, int x, int y, 
*          int r, unsigned char color);
*
*   FUNCTION
*
*   INPUTS
